...
export class CarItalianEdition implements ISystem {
  META_ID = 94 // Change to your MetaZone meta number identifier
  ...
  constructor(api, host_data) {
    ...
    this.modelEntity.addComponent(new GLTFShape('metas/caritalianedition/models/FGR3D-ITALY-CAR.glb'))
